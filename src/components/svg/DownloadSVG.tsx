...
export default function DownloadSVG({ className }: { className?: string }) {
  return (
    <svg onClick={() => {
        ...
        link.click()
    }} className={className + " active:text-[var(--selected)] hover:cursor-pointer hover:text-[var(--text)]"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
